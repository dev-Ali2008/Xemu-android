...
bool VulkanRenderer::createGraphicsPipeline() {
    auto vertShaderCode = readFile("shaders/vertex_shader.vert");
    auto fragShaderCode = readFile("shaders/fragment_shader.frag");
...
std::array<VkVertexInputAttributeDescription, 3> VulkanRenderer::Vertex::getAttributeDescriptions() {
