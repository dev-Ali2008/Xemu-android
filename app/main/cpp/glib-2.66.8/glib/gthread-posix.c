...
{
#ifndef __ANDROID__
  /* FIX: On Android, glib may free mutexes while other threads still hold
   * them (e.g. during _exit(0) teardown), causing bionic FORTIFY crashes.
   * Skip destroy; the OS reclaims memory on process exit. */
